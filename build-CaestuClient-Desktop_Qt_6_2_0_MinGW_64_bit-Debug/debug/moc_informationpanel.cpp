...
#include <memory>
#include "../../CaestuClient/informationpanel.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_InformationPanel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_InformationPanel_t qt_meta_stringdata_InformationPanel = {
    {
QT_MOC_LITERAL(0, 16) // "InformationPanel"
...
const QMetaObject InformationPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_InformationPanel.offsetsAndSize,
    qt_meta_data_InformationPanel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_InformationPanel_t
, QtPrivate::TypeAndForceComplete<InformationPanel, std::true_type>
