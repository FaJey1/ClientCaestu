...
#include <memory>
#include "../../CaestuClient/calibration.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Calibration_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Calibration_t qt_meta_stringdata_Calibration = {
    {
QT_MOC_LITERAL(0, 11) // "Calibration"
...
const QMetaObject Calibration::staticMetaObject = { {
    ...
    qt_meta_stringdata_Calibration.offsetsAndSize,
    qt_meta_data_Calibration,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Calibration_t
