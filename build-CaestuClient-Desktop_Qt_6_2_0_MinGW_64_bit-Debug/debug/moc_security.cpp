...
#include <memory>
#include "../../CaestuClient/security.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_security_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_security_t qt_meta_stringdata_security = {
    {
QT_MOC_LITERAL(0, 8) // "security"
...
const QMetaObject security::staticMetaObject = { {
    ...
    qt_meta_stringdata_security.offsetsAndSize,
    qt_meta_data_security,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_security_t
, QtPrivate::TypeAndForceComplete<security, std::true_type>
